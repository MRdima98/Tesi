...
EC2 ha supporto per processori intel, AMD e Arm, coprendo ogni tipologia di 
macchina incluso macOS.
...
Nel secondo caso non appena l'istanza si fermi, sia per un malfunzionamento 
...
Naturalmente non è una tecnologia adatto a ogni caso. 
